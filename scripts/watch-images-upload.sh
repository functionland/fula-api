...
# gateway log filtered to lines that pinpoint where Phase 1.2 / v0.5.2
...
#   * "Populated forest_manifest_cid" — v0.5.2 ran (good — should appear on every Phase 2 root commit)
