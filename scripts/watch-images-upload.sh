...
# gateway log filtered to lines that pinpoint where Phase 1.2 / v0.4.4
...
#   * "Populated forest_manifest_cid" — v0.4.4 ran (good — should appear on every Phase 2 root commit)
